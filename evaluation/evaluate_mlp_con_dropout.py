...
model_path = "models/mlp_con_dropout.keras"

# Cargar los datos preprocesados
data_path = "data/data.csv"
X, y = preprocess_data(data_path)

def evaluate_mlp_con_dropout():
    """Evalúa el modelo MLP con Dropout y genera métricas."""
...
if __name__ == "__main__":
    evaluate_mlp_con_dropout()

    # Si tienes guardado el historial, puedes graficarlo:
    # history_path = "models/mlp_con_dropout_history.npy"
